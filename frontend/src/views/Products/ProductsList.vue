    ...
    <div>
      ...
      <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="relative">
          ...
          <svg class="absolute right-4 top-1/2 h-5 w-5 -translate-y-1/2 text-black dark:text-white" fill="none"
      ...
      <!-- Error Message -->
      <ErrorMessage v-if="productsStore.error" :message="productsStore.error" @dismiss="productsStore.clearError"
        class="mb-4" />
      ...
      <div v-else
        ...
        <div
          class="grid grid-cols-7 border-t border-stroke px-4 py-4.5 dark:border-strokedark sm:grid-cols-9 md:px-6 2xl:px-7.5">
      ...
      <div v-if="productsStore.totalProducts > 0" class="mt-6 flex items-center justify-between">
        <div class="text-sm text-gray-700 dark:text-gray-300">
          نمایش صفحه {{ (currentPage - 1) + 1 }} <span class="text-lg">↫</span> {{ Math.min(currentPage * pageSize,
